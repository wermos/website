<details>
In this short lesson, we will study a simple but useful method to move 3D cameras. To understand this lesson, you will need to be familiar with the concept of transformation matrix and cross-product between vectors. If that's not already the case, you can first read the lesson devoted to [geometry](lessons/mathematics-physics-for-computer-graphics/geometry).
</details>
