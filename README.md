...
**Please be sure you regularly pull changes from the repisotry before making edits**. Here is a link that will tell you how to do that: [Pull new updates from original GitHub repository into forked GitHub repository](https://stackoverflow.com/questions/3903817/pull-new-updates-from-original-github-repository-into-forked-github-repository).
